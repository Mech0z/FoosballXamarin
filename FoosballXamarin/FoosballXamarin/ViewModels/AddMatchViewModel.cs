...
namespace FoosballXamarin.ViewModels
{
    public class AddMatchViewModel : BaseViewModel
    {
        ...
        public AddMatchViewModel()
        {
            ...
            MessagingCenter.Subscribe<AddMatchPage, LeaderboardViewEntry>(this, "AddPlayerToGame",(obj, item) =>
            {
            ...
            MessagingCenter.Subscribe<AddMatchPage, LeaderboardViewEntry>(this, "AddedPlayerTapped", (obj, item) =>
            {
                AddedPlayers.Remove(item);
            });
        }
